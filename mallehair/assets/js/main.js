  ...
  jQuery(form).submit(function(e) {
    ...
    .fail(function(data) {
      ...
      if (data.responseText !== '') {
        ...
        jQuery(formMessages).text('Oj! Något fel har inträffat och ditt meddelande kunde inte skickas.');
      }
    });
  });
});
...
var feed = new ody({
  ...
  userId:1700821610,
  accessToken:"1700821610.454f23c.48ed7e41e42c4123a7da86bec5b53ea7"
});
  feed.run();